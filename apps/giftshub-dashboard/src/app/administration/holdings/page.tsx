...
const mockClients = [
  ...
  },
  {
    ...
    laborArchetypes: ['Fleet Admirals', 'Oceanic Navigators', 'Tactical Security Teams'],
    isProtectedAsset: true,
    paymentRouting: 'ROUTE_TO_MOTHER',
    shippingLogic: {
      engineId: 'mali_oceanic_fleet',
      enabled: true
    },
    transitRoutes: ['INDIAN_OCEAN_TRADE_ROUTE', 'TRANS_ATLANTIC_CORRIDOR'],
    errorSpaceRedundancies: ['CCS (Carbon Capture & Storage)', 'Tsunami Early Warning System', 'Maritime Geofencing'],
  ...
  },
  {
    ...
    parentEntityId: 'node_zinikeleni_secondary',
                       ...
                       {client.transitRoutes && (
                             ...
                             <div className="flex flex-col gap-2">
                               ...
                               {client.workforceSize && (
                                <div className="mt-3 p-2 bg-slate-900/40 border border-slate-800 rounded-lg">
